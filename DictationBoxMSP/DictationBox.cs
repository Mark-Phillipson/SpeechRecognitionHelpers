	...
	public partial class DictationBoxForm : Form
	{
		...
		private void SearchButton_Click(object sender, EventArgs e)
		{
			...
			if (searchString == null)
			{
			 ...
			 var encodedString= System.Web.HttpUtility.UrlEncode(searchString);
			string url = $"https://www.bing.com?q={encodedString}";

			// Use Process.Start method to open a browser window with the specified URL
			...
			{
				MessageBox.Show(exception.Message, "Clipboard Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
			//Process proc = new Process();
			//          proc.StartInfo.UseShellExecute = true;
			//          proc.StartInfo.FileName = "https://www.google.com/search?client=firefox-b-d&q=" + searchString;
			//          proc.Start();
