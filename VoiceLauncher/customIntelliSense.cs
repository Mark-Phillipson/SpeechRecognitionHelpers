...
namespace VoiceLauncher
{
    ...
    {
        private readonly VoiceLauncherContext db;
        ...
        private void toolStripTextBoxSearch_Leave(object sender, EventArgs e)
        {
            ...
            {
                filteredData = db.CustomIntelliSenses.Local.ToBindingList().Where(v => v.Display_Value.ToLower().Contains(this.toolStripTextBoxSearch.Text.ToLower()));
